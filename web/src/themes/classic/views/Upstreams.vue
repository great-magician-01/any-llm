...
function edit(u: Upstream) { editing.value = u; form.value = { ...u }; expiryPicker.value = isoToExpiry(u.expires_at); formTestResult.value = null; showForm.value = true }
...
const columns: DataTableColumns<Upstream> = [
  ...
  { title: '操作', key: 'actions', width: 440, render: (row) => h(NSpace, { size: 8, wrap: false }, {
    default: () => [
