<script lang="ts">
/**
 * 轻量内联 SVG 图标（stroke 风格路径），避免引入图标库依赖。
 * 全部为静态可信内容，使用 v-html 注入。
 */
const icons = {
  dashboard:
  ...
  chart:
    '<path d="M3 3v18h18"/><path d="M8 17v-6"/><path d="M13 17V7"/><path d="M18 17v-3"/>',
  logout:
  ...
  check:
    '<circle cx="12" cy="12" r="9"/><path d="m8.5 12.2 2.4 2.4 4.8-5"/>',
  arrow:
